...
<body style="background-image: url(img/CODE.jpg);">
    <div class="flex justify-center items-center h-screen">
        <div class="bg-white p-[9vh]  rounded-lg shadow-md w-[32vw]">
            <h1 class="text-[2.5vw] font-bold text-center mb-5">Register</h1>
            <div class="flex justify-around items-center space-x-8 mx-24">
                <p class="text-[1.5vw]"><a href="{{ url('') }}">Login</a></p>
                <p class="text-[1.5vw] underline" ><a href="link-disabled">Register</a></p>
            </div>
            <form class="mt-4">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" class="border rounded-md px-4 py-2 w-full" required>
                        ...
                        <div class="mb-4">
                <label for="email" class="block text-gray-700 font-bold mb-2">No. HP:</label>
                <input type="tel" id="email" name="email" class="border rounded-md px-4 py-2 w-full" required>
            </div>
            <div class="mb-4">
            ...
            <div class="flex justify-center">
                <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-md"><a href="{{ url('/kontak') }}">Register<a></button>
            </div>
            </form>
        </div>
    </div>
